...
// PatchCoords holds the ephemeral container connection details used to
// overwrite liquibase.properties before invoking Maven.
type PatchCoords struct {
	Host     string
	Port     int
	User     string
	Password string
...
func (pt *Patcher) Patch(path string, coords PatchCoords) error {
